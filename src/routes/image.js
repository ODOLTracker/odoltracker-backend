...
router.post('/upload', validate(imageValidation.uploadImage), imageController.uploadImage);
...
router.get('/:detectionID/current-image-to-verify', validate(imageValidation.getCurrentImageToVerify), imageController.getCurrentImageToVerify);

router.get('/:detectionID/next-image-to-verify', validate(imageValidation.getNextImageToVerify), imageController.getNextImageToVerify);
